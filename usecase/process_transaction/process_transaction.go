...
import (
	"github.com/jvcalassio/fc-payment-gateway/domain/repository"
	"github.com/jvcalassio/fc-payment-gateway/domain/entity"
	"github.com/jvcalassio/fc-payment-gateway/adapter/broker"
)
...
func (p *ProcessTransaction) Execute(input TransactionDtoInput) (TransactionDtoOutput, error) {
	...
	cc, invalidCC := entity.NewCreditCard(input.CreditCardNumber, input.CreditCardName, input.CreditCardExpMonth, input.CreditCardExpYear, input.CreditCardCVV)
